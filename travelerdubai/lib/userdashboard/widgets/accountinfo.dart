                ...
                children: [
                  Expanded(
                    child: Container(
                      ...
                      child: Obx(() {
                        return Text("${details.value.username ??
                            "set username"}");
                      }),
                    ),
                  ),
                  ...
                  Expanded(
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                          ...
                          color: colorwhite),
                      margin: EdgeInsets.only(bottom: 8.0),
                      child: Text("${details.value.mobileNo??'N/A'}"),
                    ),
                  ),
                  Expanded(
                    child: Container(
                    ...
                    children: [
                      Expanded(
                        child: Container(
                          ...
                          child: Obx(() {
                            return Text(
                                "${details.value.username ?? "set username"}");
                          }),
                        ),
                      ),
                      ...
                      Expanded(
                        child: Container(
                          ...
                          margin: const EdgeInsets.only(bottom: 8.0),
                          child: Obx(() {
                            return Text(details.value.email);
                          }),
                        ),
                      ),
                    ],
                    ...
                    children: [
                      Expanded(
                        child: Container(
                          ...
                          child: Obx(() {
                            return Text(
                                details.value.dob?.toString().substring(
                                    0, 10) ??
                                    'N/A');
                          }),
                        ),
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Container(
                          ...
                          margin: EdgeInsets.only(bottom: 8.0),
                          child: Obx(() {
                            return Text("${details.value.address ?? 'N/A'}");
                          }),
                        ),
                      ),
                    ],
