        ...
        return Expanded(
          child: ListView.builder(
            ...
            itemBuilder: (BuildContext context, int index) {
              ...
              Future<void> timeSlotsFuture = optionsStatic.getTimeSlots();
              return FutureBuilder<void>(
                  ...
                  builder:
                    ...
                    if (snapshot.connectionState == ConnectionState.waiting) {
                      ...
                      if (kDebugMode) {
                        print(
                            'time slot is ${optionsStatic.timeslots.value.data?.toList()}');
                      }
                      var lst = optionsStatic.timeslots.value.data!.isNotEmpty
                                  ...
                                  Row(
                                    ...
                                    children: <Widget>[
                                      index >= 0
                                          ...
                                          : const Text(''),
                                      Obx(() {
                                        if (optionsStatic.dateTextController
                                                .value.text !=
                                            '') {
                                          return Flexible(
                                            flex: 1,
                                      ...
                                      Obx(() {
                                        switch (optionsStatic
                                            .timeslots.value.state) {
                                        ...
                                        child: InlineFlexButton(
                                          ...
                                          onPressed: () async {
                                            ...
                                            var value = UpdateCartTourDetail(
                                                ...
                                                adultRate:
                                                    data.adultPrice!.toDouble(),
                                                childRate: data.childPrice
                                                        ?.toDouble() ??
                                                    0.0,
                                                serviceTotal: ((output1[index].finalAmount ?? 0) +
